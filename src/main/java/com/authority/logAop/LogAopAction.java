...
import com.authority.entity.LogFormMap;
import com.authority.mapper.LogMapper;
...
public  class LogAopAction {
    ...
    @Inject
     ...
     //Controller层切点
    @Pointcut("@annotation(com.authority.annotation.SystemLog)")
