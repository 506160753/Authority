<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="col-md-12">
		...
		<table>
		<tr>
		<td align="center" colspan="2"><h1><%--权限开源系统</h1>--%>欢迎光临</td>
		</tr>
		<tr>
		<td><div class="topBtn" style="font-size: 15px;">
		          	...
		          	<div style="padding-left: 20px;color: red;">	
								系統说明：</div>
								<div style="padding-left: 50px;color: red;">采用最新的技术流行框架：springMVC4.1.4+shiro1.2.3+spring4.x+Mybaits3.2.8+Ajax+html5<br>
								</div>
								<div style="padding-left: 20px;">
									...
									技术要点：
									<div style="padding-left: 20px;">
									1：此版本采用ajax+js分页,表格lyGrid分页插件模仿ligerui的分页实现
									...
									9：<font color="blue">支持SQLserver2008分页实现</font><br>
									10：<font color="blue">异常统一处理</font><br>
									11：<font color="blue">使用spring Security3权限安全机制,采用了shiro权限机制</font><br>
									12：<font color="blue">封装好baseSerive,baseSeriveImpl,baseMapper..服务层，持久层统一调用</font><br>
									13：........<br>
								</div></div></div>
		</td>
