		...
		<header class="bg-dark dk header navbar navbar-fixed-top-xs">
			<div class="navbar-header aside-md" >
				<a class="btn btn-link visible-xs"
					...
					src="${ctx}/notebook/notebook_files/logo.png" class="m-r-sm">全屏...</a>
				<a class="btn btn-link visible-xs" data-toggle="dropdown"
					data-target=".nav-user"> <i class="fa fa-cog"></i>
				</a>
			</div>
			<ul class="nav navbar-nav hidden-xs">
				<li class="dropdown"><a href="javascripte:void(0);"
					class="dropdown-toggle dker"> <span class="font-bold" style="font-size:22px">系统开发基础框架</span>
				</a></li>
			</ul>
